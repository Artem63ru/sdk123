...
Route::get('/routes', function() {
    ...
    echo "<td width='20%'><h4>Name</h4></td>";
    echo "<td width='20%'><h4>Corresponding Action</h4></td>";
    echo "<td width='20%'><h4>Status</h4></td>";
    ...
    foreach ($routeCollection as $key=>$value) {
        if($value->methods()[0]=='GET') {
            if ($value->uri()=='test_data'

                or $value->uri()=='opo_plan/{opo}'
                or $value->uri()=='element/{elem}'
                or $value->uri()=='element/{elem_id}/oto/{oto}'
                or $value->uri()=='ref_opo'
                or $value->uri()=='tests'
                or $value->uri()=='docs/status_elem_day'
                or $value->uri()=='docs/status_elem_day/{id}/day'
                or $value->uri()=='docs/status_elem_month'
                or $value->uri()=='docs/status_elem_day/{id}/month'
                or $value->uri()=='docs/status_elem_quarter'
                or $value->uri()=='docs/status_elem_day/{id}/quarter'
                or $value->uri()=='docs/scena_report_day'
                or $value->uri()=='docs/scena_report/{id}/day'
                or $value->uri()=='docs/scena_report_month'
                or $value->uri()=='docs/scena_report/{id}/month'
                or $value->uri()=='docs/scena_report_quarter'
                or $value->uri()=='docs/scena_report/{id}/quarter'
                or $value->uri()=='docs/result_pk_day'
                or $value->uri()=='docs/result_pk/{id}/day'
                or $value->uri()=='docs/result_pk_month'
                or $value->uri()=='docs/result_pk/{id}/month'
                or $value->uri()=='docs/result_pk_quarter'
                or $value->uri()=='docs/result_pk/{id}/quarter'
                or $value->uri()=='docs/violations_report_day'
                or $value->uri()=='docs/violation_report/{id}/day'
                or $value->uri()=='docs/violations_report_month'
                or $value->uri()=='docs/violation_report/{id}/month'
                or $value->uri()=='docs/violations_report_quarter'
                or $value->uri()=='docs/violation_report/{id}/quarter'
                or $value->uri()=='docs/status_opo_day'
                or $value->uri()=='docs/scena_report_month'
                or $value->uri()=='docs/scena_report/{id}/month'
                or $value->uri()=='docs/scena_report_quarter'
                or $value->uri()=='docs/scena_report/{id}/quarter'
                ...
                or $value->uri()=='docs/result_pk_month'
                or $value->uri()=='docs/result_pk/{id}/month'
                or $value->uri()=='docs/status_opo_month'
                or $value->uri()=='docs/status_opo_quarter'
                or $value->uri()=='docs/repiat_report_day'
                or $value->uri()=='docs/repiat_report/{id}/day'
                or $value->uri()=='docs/repiat_report_month'
                or $value->uri()=='docs/repiat_report/{id}/month'
                or $value->uri()=='docs/repiat_report_quarter'
                or $value->uri()=='docs/repiat_report/{id}/quarter'
                or $value->uri()=='docs/event_pk_day'
                or $value->uri()=='docs/event_pk/{id}/day'
                or $value->uri()=='docs/event_pk_month'
                or $value->uri()=='docs/event_pk/{id}/month'
                or $value->uri()=='docs/event_pk_quarter'
                or $value->uri()=='docs/event_pk/{id}/quarter'
                or $value->uri()=='docs/quality_criteria_day'
                or $value->uri()=='docs/quality_criteria/{id}/day'
                or $value->uri()=='docs/quality_criteria_month'
                or $value->uri()=='docs/quality_criteria/{id}/month'
                or $value->uri()=='docs/quality_criteria_quarter'
                or $value->uri()=='docs/quality_criteria/{id}/quarter'
                ...
                or $value->uri()=='pdf_elem/{start}/{finish}'
                or $value->uri()=='pdf_elem/{start}/{finish}/{term}'

                or $value->uri()=='pdf_scena/{start}/{finish}/{term}'


                or $value->uri()=='pdf_violations_report/{start}/{finish}/{term}'
                or $value->uri()=='pdf_opo/{start}/{finish}'
                or $value->uri()=='pdf_opo/{start}/{finish}/{term}'

                or $value->uri()=='pdf_repiat_report/{start}/{finish}/{term}'
                or $value->uri()=='pdf_event/{start}/{finish}/{term}'





                or $value->uri()=='pdf_quality_criteria/{start}/{finish}/{term}'
                or $value->uri()=='docs/report5'
                or $value->uri()=='docs/report6'

                or $value->uri()=='xml'
                or $value->uri()=='xml_svr'
                or $value->uri()=='xml_ssr'
                or $value->uri()=='xml_test'
                or $value->uri()=='jas_up_chek'
                or $value->uri()=='opo_day'
                or $value->uri()=='opo/charts/fetch-data'
                or $value->uri()=='charts/fetch-data'
                or $value->uri()=='charts/chart_ip_opo'
                ...
                if ( str_contains($value->uri(), 'opo/{id}') or (str_contains($value->uri(), 'opo_params/{id}')) ) {
                    for ($i=1; $i<10; $i++) {
                        $link= str_replace('{id}',$i,  $value->uri());
                        if (($link=='mini_graphics_opo/9') or      str_contains($link, 'docs/status_opo/')) {
                            echo "<tr style='background-color:red'>";
                            echo "<td>" . $value->methods()[0] . "</td>";
                            echo "<td>" .  $link . "</td>";
                            echo "<td>" . $value->getName() . "</td>";
...
//                echo "<td>" . $status . "</td>";
                ...
                elseif ($value->uri()=='get_charts_vals/{id_obj}' or $value->uri()=='charts/fetch-data_elem/{id_obj}'
                    or $value->uri()=='charts/fetch-data_elem_op_m/{id_obj}'
                    or $value->uri()=='charts/fetch-data_elem_op_r/{id_obj}'
                    or $value->uri()=='charts/fetch-data_elem_op_el/{id_obj}'
                ...
                elseif ($value->uri()=='eventsCal/{opo_id}') {
                    foreach ($id_opo as $opo) {
                        $link= str_replace('{opo_id}',$opo,  $value->uri());
                        echo "<tr>";
                        echo "<td>" . $value->methods()[0] . "</td>";
                        echo "<td>" .  $link . "</td>";
                        echo "<td>" . $value->getName() . "</td>";
