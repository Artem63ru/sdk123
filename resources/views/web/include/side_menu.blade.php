...
<div class="links_block">
    <ul>
        ...
        <li id="OPOs_link_li"><a href="{{asset('/opo/1')}}"><img alt="Настройки" src="{{asset('assets/images/icons/settings.svg')}}" class="links_block_icon"></a></li>
        <li id="docs_link_li"><a href="{{ url('/docs/rtn') }}"><img alt="Документация" src="{{asset('assets/images/icons/docs.svg')}}" class="links_block_icon"></a></li>
    </ul>
</div>
