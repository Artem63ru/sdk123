        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" >
                    ...
                    <div class="card-header"><h2 class="text-muted" style="text-align: center">Журнал действий администратора</h2></div>
        ...
        <div class="table_use" style="width: 61%; margin-left: 22.2%">
            <table class="table table-hover ">
                ...
                <tr>
                    ...
                    <td>  {{ $logs->links() }}</td>
                    @can('role-delete')
                        <td><a href="{{ url('pdf_logs_ib') }}" class="btn btn-success mb-2">Создать PDF</a>
                            <a href="{{ url('clear_logs_ib') }}" class="btn btn-danger mb-2">Очистить журнал</a></td>
                    @endcan
                </tr>
                </tbody>
            </table>
