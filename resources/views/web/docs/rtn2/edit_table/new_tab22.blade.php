...
@section('content')
    ...
    <div class="inside_content">
            <div class="inside_tab_padding">
                <div class="row_block">
                    <div style="background: #FFFFFF; height:38rem; padding: 35px; border-radius: 6px"
                         class="container1">
                    <form method="POST" action="{{ '/docs/tab22/save' }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name_o" type="text" style="width: 450px" class="form-control" name="name_o" value="{{ old('name_o') }}" autocomplete="name_o" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="last_sert" style="padding-left: 35px" class="col-md-4 col-form-label text-md-right">Сведения о последнем повышении квалификации</label>

                            <div class="col-md-6">
                                <input id="last_sert" type="text" style="width: 450px" class="form-control" name="last_sert" value="{{ old('last_sert') }}" autocomplete="last_sert" autofocus>
