                ...
                <div class="row_block">
                    ...
                    <form method="POST" action="{{ '/docs/tab22/save' }}">
                        ...
                        <div class="card-header">
                            ...
                            <div class="col-4">
                                <input id="name_o" type="text" style="width: 450px; margin-top: 7px" class="form-control" name="name_o" value="{{ old('name_o') }}" autocomplete="name_o" autofocus>
                            ...
                            <div class="col-4">
                                ...
                                @enderror
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="col-4">
                            <label for="last_sert" style="padding-left: 35px">Сведения о последнем повышении квалификации</label>
                                                            </div>
                            <div class="col-4">
                                <input id="last_sert" type="text" style="width: 450px; margin-top: 7px" class="form-control" name="last_sert" value="{{ old('last_sert') }}" autocomplete="last_sert" autofocus>
