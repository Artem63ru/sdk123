                     ...
                     class="container">
                        ...
                        <div class="card-header"><h2 class="text-muted" style="text-align: center">Редактирование записи</h2></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input id="name_o" style="width: 450px" type="text" class="form-control" name="name_o" value="{{ $data_table->name_o }}"  autocomplete="name" autofocus>
                                    <input type="hidden" name="id" value="{{ $data_table->id }}" >
                                </div>
                                ...
                                <label for="time" style="padding-left: 35px" class="col-md-4 col-form-label text-md-right">Сведения о последнем повышении квалификации</label>
                                <div class="form-group">
                                    <input id="last_sert" style="width: 450px" type="text" class="form-control" name="last_sert" value="{{ $data_table->last_sert }}" autocomplete="name" autofocus>
                                    <input type="hidden" name="id" value="{{ $data_table->id }}" >
                                </div>
