                     ...
                     class="container">
                        ...
                        <div class="card-header"><h2 class="text-muted" style="text-align: center">Редактирование записи</h2></div>
                            ...
                            <label for="time" style="padding-left: 35px" class="col-md-4 col-form-label text-md-right">Регистрационный номер ОПО</label>
                                ...
                                <div class="form-group">
                                    <input id="date" style="width: 450px" type="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ $data_table->date }}" required autocomplete="name" autofocus>
                                    <input type="hidden" name="id" value="{{ $data_table->id }}" >
                                </div>

                                <label for="doc" style="padding-left: 35px" class="col-md-4 col-form-label text-md-right">Ссылка на документ</label>
                                <div class="form-group">
                                    <input id="doc" style="width: 450px" type="text" class="form-control @error('doc') is-invalid @enderror" name="doc" value="{{ $data_table->doc }}" required autocomplete="name" autofocus>
                                    <input type="hidden" name="id" value="{{ $data_table->id }}" >
                                </div>
