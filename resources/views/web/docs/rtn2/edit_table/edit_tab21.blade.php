                     ...
                     class="container">
                        ...
                        <div class="card-header"><h2 class="text-muted" style="text-align: center">Редактирование записи</h2></div>
                            ...
                            <label for="time" style="padding-left: 35px">Регистрационный номер ОПО</label>
                                            ...
                                            <div class="col-4">
                                <input id="name_f" style="width: 450px; margin-top: 7px" type="text" class="form-control @error('num_opo') is-invalid @enderror" name="num_opo" value="{{ $data_table->num_opo }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col-4">
                                    <input id="name_o" style="width: 450px; margin-top: 7px" type="text" class="form-control @error('name_o') is-invalid @enderror" name="name_o" value="{{ $data_table->name_o }}" required autocomplete="name" autofocus>
                                    <input type="hidden" name="id" value="{{ $data_table->id }}" >
                                </div>
                                                    </div>
