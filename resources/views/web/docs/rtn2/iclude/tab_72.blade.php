...
<span id="razd_72">72</span>
<script>
    document.addEventListener('DOMContentLoaded', function (){
        var tooltip_content=document.getElementById('razd_72');
        var tooltip=new Tooltip(tooltip_content, 'razd_72_tooltip', "r72_label");
    })
</script>
...
<div style="display: inline-block; width: 4%;">
    <div style="width: 90%" class="tab">
        ...
        <label for="r72" class="tab_title razd_col_tab" id="r72_label">Раздел<br>7.2</label>
