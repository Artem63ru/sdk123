...
<span id="razd_83">83</span>
<script>
    document.addEventListener('DOMContentLoaded', function (){
        var tooltip_content=document.getElementById('razd_83');
        var tooltip=new Tooltip(tooltip_content, 'razd_83_tooltip', "r83_label");
    })
</script>
...
<div style="display: inline-block; width: 4%;">
    <div style="width: 90%" class="tab">
        ...
        <label for="r83" class="tab_title razd_col_tab" id="r83_label">Раздел<br>8.3</label>
