...
{{--                    {!! Form::open(array('route' => 'form51.store','method'=>'POST')) !!}--}}
                    ...
                    <div class="card-header">
                        <div class="row justify-content-start">
                            ...
                            <div class="col">
                                {!! Form::select('supervision', array('РТН' => 'Ростехнадзор', 'ГН' => 'Газнадзор')) !!}
{{--                                <select style="width: 50%" class="form-select mb-3"--}}
...
{{--                                </select>--}}
                    ...
                    <div class="card-header">
                        <div class="row justify-content-start">
                            ...
                            <div class="col">
                                {!! Form::select('organisation', array('ГДА' => 'ООО Газпром Добыча Астрахань')) !!}
                                </select>
                            </div>
                        </div>
                    </div>
