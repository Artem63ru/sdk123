...
{{--            <div class="card-header"><h2 class="text-muted" style="text-align: center" >Редактирование информации о ОПО</h2></div>--}}
{{--        </div>--}}
        ...
        <div class="inside_tab_padding">
            <div class="row_block">
                <div style="background: #FFFFFF; height:45rem; padding: 35px; border-radius: 6px"
                     class="container">
                    <div class="card-header"><h2 class="text-muted" style="text-align: center" >Редактирование информации о ОПО</h2></div>
                {!! Form::model($data, ['method' => 'POST','route' => ['update_OPO', $data->idOPO]]) !!}
