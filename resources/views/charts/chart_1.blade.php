...
<figure class="highcharts-figure">
    <div id="container-chart_1" class="chart-container"></div>
...
<script language="JavaScript">
    ...
    // The speed gauge
    var chartSpeed = Highcharts.chart('container-chart_1', Highcharts.merge(gaugeOptions, {
        yAxis: {
            min: 0,
            max: 1,
            title: {
