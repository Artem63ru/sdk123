...
<script language="JavaScript">
    ...
    var Ip_elem = {{$mins_opo_months->ip_opo}};
    ...
    yearLabel.text = "[bold]{{$mins_opo_months->ip_opo}}[/]";
    yearLabel.horizontalCenter = 'middle'
    yearLabel.verticalCenter = 'middle'
    yearLabel.x = am4core.percent(50);
    yearLabel.y = am4core.percent(50);
    yearLabel.fontSize = 20; // irrelevant, can be omitted
