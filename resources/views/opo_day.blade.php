...
{{--                                        $ip_elem1 = App\Http\Controllers\ElemController::view_oto(110);--}}

{{--                                    //   echo $ip_elem->ip_elem;--}}
{{--                                    @endphp--}}
{{--                                    <div class="text-amount text-success">{{$ip_elem->ip_elem}}<i--}}
{{--                                            class="material-icons text-success">arrow_upward</i>--}}
{{--                                    </div>--}}
                ...
                <div class="card">
                    <div class="row card-group-row">
                        <div class="col-lg-4 col-md-6 card-group-row__col">
                            ...
                            <div class="card card-group-row__card card-body card-body-x-lg flex-row align-items-center">
                                <div class="flex">
                                    <div class="card-header__title text-muted mb-2"> Это второй график</div>
                            ...
                            <div class="card card-group-row__card card-body card-body-x-lg flex-row align-items-center">
                                <div class="flex">
                                    <div class="card-header__title text-muted mb-2"> Это третий график</div>
                                    {{--                                  @include('charts.chart_3')--}}
                                </div>
                            </div>
                            <div class="card card-group-row__card card-body card-body-x-lg flex-row align-items-center">
                                <div class="flex">
                                    <div class="card-header__title text-muted mb-2"> Это четвертый график</div>
