<div style="display: inline-block; width: 10%;">
            ...
            <div class="inside_tab_padding plan_new">
                <div class="row_block plan_new plan43">
                    <table>
                        <thead>
                        <tr>
                            <th colspan="3" class="centered">ФИО сотрудника, организующего ПК</th>
                        ...
                        @foreach ($rows as $row)
                            <tr>
                                ...
                                <td class="hover_links">
                                    ...
                                    <a href="#openModal43"><img wire:click="edit({{ $row->id }})" alt="" src="{{asset('assets/images/icons/edit.svg')}}" class="check_i"></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <div id="openModal43" class="modal">
                ...
                <div class="modal-body ">
                    ...
                    <form>
                        <table class="modal_table map_hover">
                            <tbody>
                            <tr>
                                <td>Фамилия сотрудника, организующего ПК </td>
