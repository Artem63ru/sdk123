                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="row justify-content-start">
                            <div class="col">
                                <h4 class="text-muted" style="text-align: left">№ Акта технического расследования причин
                                    инцидента
                                </h4>
                            </div>
                            <div class="col">
                    ...
                    <div class="card-header">
                        <div class="row justify-content-start">
                            <div class="col">
                                <h4 class="text-muted" style="text-align: left">Наименование структорного подразделения
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Полное наименование
                            участка,установки, цеха, инвентарный номер, регистрационный номер ОПО, на котором произошёл
                            инцидент</h4>
                        <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Комиссия в составе:</h4>
                        ...
                        <td>
                            <div class="card-header"><h5 class="text-muted" style="text-align: left">Члены
                                    комиссии:</h5>
                                <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Краткая характеристика
                            установки (отделения, участка), где произошел инцидент</h4>
                        <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Обстоятельства
                            инцидента</h4>
                        <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Заключение о лицах,
                            ответственных за нарушения, которые привели к инциденту</h4>
                        <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Последствия от
                            инцидента</h4>
                        <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Наличие аналогичных
                            случаев</h4>
                        <div class="form-group">
                    ...
                    <div class="card-header"><h4 class="text-muted" style="text-align: left">Организационно-технические
                            мероприятия по ликвидации последствий инцидента и предупреждению подобных случаев в
                            дальнейшем:</h4>
                                ...
                                <table>
                                    ...
                                    @foreach ($rows as $row)
                                        <tr>
                                            ...
                                            <td>{{$row->note}}</td>
                                            <td class="centered">
                                                <a href="{{ route('form52-change-table',$row->id_event) }}"><img alt=""
                                                                                                                 src="{{asset('assets/images/icons/edit.svg')}}"
                                                                                                                 class="check_i"></a>

                                                <a href="{{ route('form52-delete-table',$row->id_event) }}">
                                                    <img alt="" src="{{asset('assets/images/icons/trash.svg')}}"
                                                         class="trash_i"
                                                         style="width: 15px; height: 15px; margin-top:3px; margin-right: 50px"/>
                                                </a>
                        ...
                        <div style="padding-bottom: 40px; margin-top: 30px"
                            ...
                            <div style="padding-bottom: 40px; margin-top: 20px"
                                 class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" name="save" value="Update_childtablle" class="btn btn-primary">
                        ...
                        <div class="card-header">
                            <div class="row justify-content-start">
                                <div class="col"><h4 class="text-muted" style="text-align: left">Дата составления
                                        акта</h4>
                                </div>
                                <div class="col">
