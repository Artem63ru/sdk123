...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Edit') }}  пользователя</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('update_user') }}">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Отчество') }}</label>

                                <div class="col-md-6">
                                    <input id="middle_name" type="text" class="form-control @error('middle_name') is-invalid @enderror" name="middle_name" value="{{ $users->middle_name }}" required autocomplete="middle_name" autofocus>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="checkbox" value="123" id="flexCheckChecked"  checked>
                                        @else
                                    ...
                                    <div class="form-check">
                                        @if($users->hasRole('ingener'))
                                        <input class="form-check-input" type="checkbox" name="checkbox1" value="False" id="flexCheckChecked" checked>
                                        @else
