...
return [
    ...
    */
    ...
    'before'               => 'В поле :attribute должно быть значение раньше :date.',
    ...
    */
    ...
    'attributes' => [
//        строка name расшифровывалась как "имя", но пришлось поменять на "логин" для корректного отображения
        'time_begin'            => 'Время начала доступа к системе',
        'name'                  => 'Логин',
        'username'              => 'Никнейм',
        'email'                 => 'E-Mail адрес',
        'first_name'            => 'Имя',
        ...
        'available'             => 'Доступно',
        'size'                  => 'Размер',
//        для обработки ошибок при регистрации(изменении) пользователей
        'imya'                  => 'Имя',
        'surname'               => 'Фамилия',
